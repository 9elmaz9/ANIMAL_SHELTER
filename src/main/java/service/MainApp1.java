...
import model.Dog;
import model.Monkey;
import repository.AnimalShelter1;
import repository.Disease;
...
public class MainApp1 {
    public static void main(String[] args) {
        ...
        Monkey jon = new Monkey(true, 28, "Artur", 28, true);
        Monkey mary = new Monkey(false, 29, "Kira", 29, true);
        Monkey leen = new Monkey(true, 27, "Lola", 27, false);
        Monkey martin = new Monkey(false, 26, "Bim", 26, false);
        Cat cat1 = new Cat();
        Cat cat2 = new Cat();
        Cat cat3 = new Cat();
        Dog dog1 = new Dog();
